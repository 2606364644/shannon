...
from supernova_core.models.audit import AgentEndResult, AgentLogDetails, ResumeInfo, WorkflowSummary
...
class AuditSession:
    ...
    async def initialize(self, workflow_id: str | None = None, *,
        ...
        写 events.ndjson。None 时 WorkflowLogger 回落 env SUPERNOVA_WEB_EVENT_FILE（CLI 路径）。
