...
can be used interchangeably by the rest of supernova.
"""
...
class BrowserEngine(Protocol):
    ...
    every method / property listed here so the rest of supernova can treat
    them uniformly.
    """
...
class BrowserEngineFactory:
    ...
    def resolve_name(cls, config_path: str | None = None) -> str:
        ...
        1. ``SUPERNOVA_BROWSER_ENGINE`` env var (highest)
