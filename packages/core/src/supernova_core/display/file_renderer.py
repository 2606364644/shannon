...
line, matching the COMPLETION_PATTERN in supernova_core.cli.logs.
"""
...
class FileLogRenderer:
    def __init__(self, writer) -> None:
        # writer satisfies supernova_core.display.types.LineWriter (async write(str))
        self._writer = writer
    ...
    def _header(self, e) -> str:
        lines = [_SEP, "Supernova Pentest - Workflow Log", _SEP]
        if e.workflow_id:
