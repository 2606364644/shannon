...
(`supernova_core.code_index.patterns`) — imported, not reimplemented.
...
def _is_route_registration_block(blk: FuncBlock, hr_count_for_fb: int) -> bool:
    ...
    """
    from supernova_core.code_index.entry_points import _EXPRESS_ROUTE_PATTERN
...
def _idor_reaches_sink(
    ...
    """
    from supernova_core.code_index.chain_propagator import _map_call_site_params
