...
def test_builtin_context_table_has_glm():
    from shannon_core.agents.model_caps import MODEL_CONTEXT_WINDOWS
...
def test_get_context_window_builtin_model():
    from shannon_core.agents.model_caps import get_model_context_window
...
def test_get_context_window_unknown_model_falls_back_default():
    from shannon_core.agents.model_caps import DEFAULT_CONTEXT_WINDOW, get_model_context_window
...
def test_get_chunk_token_threshold_derives_from_context():
    ...
    from shannon_core.agents.model_caps import CHUNK_RESERVE_RATIO, get_chunk_token_threshold
